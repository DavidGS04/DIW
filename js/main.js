// Efecto de cambio de tama帽o y sombra en la barra de navegaci贸n al hacer scroll
...
// Animaci贸n bot贸n de Instagram (P谩gina de Inicio)
var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
    return new bootstrap.Tooltip(tooltipTriggerEl)
})

// Animaci贸n de p茅talos cayendo (P谩gina Multimedia)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Cargar duraci贸n cuando est茅 disponible
    ...
    // Click en barra de progreso (cambiar posici贸n)
    function seek(e) {
...
});"// 24-abr: animaci canvas de p倀alos" 
